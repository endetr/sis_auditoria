...
<script>
    Phx.vista.PlanificarAuditoria = {
        ...
        arrayDefaultColumHidden:[/*'documento',*/'codigo_aom','id_tipo_om','id_gconsultivo','nombre_aom2'/*,'lugar'*/,'descrip_aom2',/*'fecha_prev_inicio','fecha_prev_fin',*/
            ...
            'formulario_ingreso','estado_wf','estado_form_ingreso','usuario_ai','id_proceso_wf','id_estado_wf'],
        tabsouth:[
            {
        ...
        sigEstadoAutomatico: function(data){
            //var data = this.getSelectedData();
            console.log("valor del id aom gggggggggggggg -->",data.id_aom, data.lugar,data.id_tnorma,data.id_tobjeto,data.fecha_eje_inicio,data.fecha_eje_fin);
        ...
        preparaMenu:function(n){
            ...
            if(data.estado_wf == 'planificacion' || data.estado_wf == 'prog_aprob'){
                this.getBoton('sig_estado').enable();
                //this.getBoton('ant_estado').enable();
            }
            if(data.estado_wf == 'planificacion' || data.estado_wf == 'vob_planificacion'){
                this.getBoton('ant_estado').enable();
            }
