...
<script>
    Phx.vista.VBPlanificacionAuditoria = {
        ...
        constructor: function(config) {
            ...
            this.init();
            this.load({params:{start:0, limit:this.tam_pag, v_estado_wf_vb:'vob_planificacion', v_estado_wf_vb1: 'plan_observado'/*, v_tipo_auditoria:'AI'*/}});
        ...
        preparaMenu:function(n){
            var data = this.getSelectedData();
            Phx.vista.VBPlanificacionAuditoria.superclass.preparaMenu.call(this);
            //this.getBoton('btnPlanificarAudit').enable();

            //this.getBoton('btnNotificarAuditoriaProgramada').enable();
            if (data.estado_wf == 'vob_planificacion'){
                this.getBoton('ant_estado').enable();
                this.getBoton('sig_estado').enable();
            }
            /*this.getBoton('ant_estado').enable();
            if(data.estado_wf == 'plan_observado'){
        ...
        liberaMenu:function(n){
            ...
            Phx.vista.VBPlanificacionAuditoria.superclass.liberaMenu.call(this);
