CREATE OR REPLACE FUNCTION ssom.f_lista_funcionario_gerente_cd_wf_sel (
...
***************************************************************************
 SCRIPT: 		ssom.f_lista_funcionario_gerente_cd_wf_sel
...
***************************************************************************
 ...
 DESCRIPCIÓN: Implementacion al SSOM
 AUTOR: SAZP       
 FECHA: 12/11/2019      
...
BEGIN
    v_nombre_funcion ='ssom.f_lista_funcionario_gerente_cd_wf_sel';
    ...
    IF not p_count then
             ...
             v_consulta:='SELECT
                            ...
                            1 as prioridad
                         FROM orga.vfuncionario fun WHERE fun.id_funcionario = '||COALESCE(v_id_funcionario_gerente,0)::varchar||'
                         and '||p_filtro||'
